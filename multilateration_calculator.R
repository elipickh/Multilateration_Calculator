...
# This is an R rewrite of Paul Hayes' [adaption](https://github.com/paulhayes/MultilaterationExample) in Python 
# of André Andersen's multilateration [method](http://blog.andersen.im/2012/07/signal-emitter-positioning-using-multilateration).
#
############################
